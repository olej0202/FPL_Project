...
def optimize_my_team(team_id=7025308,wildcard_round=8, bb_round=10,free_hit_round=40,Last_GW=7,banned_list=[],GW_list=["0","8","9","10","11","12","13","14"],n_hits=0, current_player_path="Raw_Data_25/current_players.csv"):
