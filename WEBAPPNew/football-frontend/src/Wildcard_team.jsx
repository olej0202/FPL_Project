...
export default function WildcardTeam() {
  ...
  return (
    <div className="min-h-screen bg-slate-700 text-white flex flex-col items-center py-4 px-1 space-y-3">
      ...
      {sortedPlayers.map((player, idx) => {
        ...
        return (
          ...
          >
            ...
            {/* Captain badge */}
            {player.Is_captain && (
              <div className="absolute top-0 -left-2 bg-slate-700 text-white font-bold text-xs rounded-full w-5 h-5 flex items-center justify-center z-10">
                C
              </div>
            )}
