    ...
    >
      <div className="mx-auto max-w-7xl">
        ...
        <section className="mb-6">
          <div className="max-w-sm mx-auto w-full rounded-2xl border border-slate-200 bg-white shadow-xl px-4 py-3">
            <label
              htmlFor="metric"
              className="block text-xs uppercase tracking-wide text-slate-600 mb-1"
            >
              Metric
            </label>
              ...
              <tbody>
                {tableData.map((row, idx) => {
                  ...
                  return (
                    <tr
                      key={row.team_name}
                      className="odd:bg-slate-100 even:bg-slate-50 hover:bg-slate-100 transition-colors"
                    >
