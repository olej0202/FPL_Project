...
def current_players(season):
    ...
    players_new=players[["code","element_type", "photo","team_code","team","opta_code","now_cost","selected_by_percent","expected_goals","web_name","news","defensive_contribution_per_90"]]
